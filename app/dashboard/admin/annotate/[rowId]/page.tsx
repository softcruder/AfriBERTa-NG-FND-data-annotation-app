...
export default async function AdminAnnotatePage({ params }: { params: Promise<{ rowId?: string }> }) {
  ...
  if (!rowId) redirect("/dashboard/admin")
  return <AnnotateTaskPage rowId={rowId} role="admin" />
}
